...
# Load an image using Pillow and create a CTkImage object
ctk_image = ctk.CTkImage(light_image=Image.open("mango.jpg"), size=(300, 400))  # Load and resize the image
image_lbl = ctk.CTkLabel(frame_1_1, image=ctk_image, text="mango")  # Create a label to display the image
image_lbl.pack(fill="both", expand=True)  # Pack the label to fill the sub-frame
